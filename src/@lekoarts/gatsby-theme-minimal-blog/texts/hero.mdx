<Text sx={{ fontSize: [4, 5, 6], fontWeight: `bold`, color: `heading`, textAlign: `center` }}>
  Vote <em>September 8th</em> for Christine Seibert
  <img src="./christine_seibert_profile_icon_256.png" alt="Christine Seibert Portrait"/>
</Text>

My name is Christine Seibert, and I am running for NH State Representative (District 8) in Manchester Ward 1.  
